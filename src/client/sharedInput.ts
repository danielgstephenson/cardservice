...
const sharedInput: Input = {
  ...
  cardDetails: {
    ...
    firstPowers: [
      'Use the powers on the lowest rank blue played card',
      ...
      'If anyone other than you played a blue card, take 2 pawns into your hand',
      ...
      'Earn the lowest blue played rank in coins',
      'If the rightmost card in your deck is blue, draw 5',
    ...
    secondPowers: [
      ...
      'Use the powers on the highest rank blue played card or highest rank blue dungeon card, whichever is higher',
      ...
      'Draw 5',
      'If the lowest or highest rank played card is blue, draw 5',
